...
def make_function_schema():
    ...
    return {
        ...
        "parameters": {"type": "object", "properties": props, "required": features},
    }


def process_openai_v2(
    batch_size: int,
    max_num: int,
    repeats: int = 2,
        ...
        while i < (max_num * repeats):
            ...
            for essay in essays:
                ...
                for repeat in range(repeats):
                    ...
                    try:
                        response, result = classifier_openai.classify_by_function(
                            input_text=essay.text,
                            function=make_function_schema(),
