...
analyze_alpha_omega <- function(data, measurement_version) {
  ...
  omega_results <- data.frame(
    ...
    alpha = c(
      format_psych(omega_o$total$raw_alpha, 2),
      format_psych(omega_c$total$raw_alpha, 2),
      format_psych(omega_e$total$raw_alpha, 2),
      format_psych(omega_a$total$raw_alpha, 2),
      format_psych(omega_n$total$raw_alpha, 2),
      format_psych(mean(c(
        omega_o$total$raw_alpha,
        omega_c$total$raw_alpha,
        omega_e$total$raw_alpha,
        omega_a$total$raw_alpha,
        omega_n$total$raw_alpha
      )), 2)
    ),
    omega = c(
